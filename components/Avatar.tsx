      ...
      <svg viewBox="0 0 200 200" className={`w-full h-full transition-all duration-700 ${bodyMotion}`}>
        ...
        <g>
          ...
          <g className="eyes-group">
            <g className="eye">
              ...
              <circle cx="85" cy="75" r="3" fill="#fff" className="eye-reflect" />
            </g>
            <g className="eye">
              <circle cx="115" cy="75" r="10" fill="#000" />
              <circle cx="115" cy="75" r="10" fill="url(#eyeGlow)" />
              <circle cx="115" cy="75" r="3" fill="#fff" className="eye-reflect" />
            </g>
            {status === AssistantStatus.LISTENING && (
              <g>
                <circle cx="85" cy="75" r="5" fill="#38bdf8" className="listen-pulse" />
                <circle cx="115" cy="75" r="5" fill="#38bdf8" className="listen-pulse" />
              </g>
            )}
          </g>
        </g>
        ...
        <g transform="translate(100, 95)">
          {status === AssistantStatus.SPEAKING ? (
            ...
            <g>
              <circle r="12" fill="none" stroke="#facc15" strokeWidth="2" strokeDasharray="4 4" className="think-rotate" />
        ...
        <circle cx="100" cy="8" r="4" className={antennaClass} />
      </svg>
    </div>
  );
};
